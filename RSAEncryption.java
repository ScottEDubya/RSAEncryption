...
/*
 * Project1Part1, runs RSA Encryption, then saves the values obtained into 3 files
 * Written by: Scott Williams
 * Submitted on 2-10-16
 */

public class RSAEncryption {

	public static void main(String[] args) {
		BigInteger p = fermatsTest(515);
		BigInteger q = fermatsTest(515);
